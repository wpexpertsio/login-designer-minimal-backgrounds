...
if ( ! class_exists( 'Login_Designer_Minimal_Backgrounds' ) ) :
	...
	final class Login_Designer_Minimal_Backgrounds {
		 ...
		 * @uses Login_Designer_Minimal_Backgrounds::includes() Include the required files.
		...
		private function includes() {
			require_once LOGIN_DESIGNER_MINIMAL_BACKGROUNDS_PLUGIN_DIR . 'includes/class-login-designer-minimal-backgrounds-notice.php';
		}
